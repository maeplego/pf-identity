...
func NewServer(cfg config.Config, acc *account.Service, sess *session.Service, repos domain.Repos, signer *oidc.Signer, clk clock.Clock) (*Server, error) {
	...
	s.mux.HandleFunc("GET /admin/api/organizations", s.handleAdminListOrganizations)
	s.mux.HandleFunc("POST /admin/api/organizations", s.handleAdminCreateOrganization)
	s.mux.HandleFunc("GET /admin/api/organizations/{id}", s.handleAdminGetOrganization)
	s.mux.HandleFunc("GET /admin/api/organizations/{id}/members", s.handleAdminListOrganizationMembers)
	s.mux.HandleFunc("POST /admin/api/organizations/{id}/members", s.handleAdminAddOrganizationMember)
	s.mux.HandleFunc("PATCH /admin/api/organizations/{id}/members/{userId}", s.handleAdminUpdateOrganizationMember)
	s.mux.HandleFunc("DELETE /admin/api/organizations/{id}/members/{userId}", s.handleAdminRemoveOrganizationMember)
